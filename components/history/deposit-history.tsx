...
import { DepositDetails } from "@/components/history/deposit-details"
      ...
      cell: ({ row }: { row: any }) => (
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="icon"
            className="h-8 w-8"
            onClick={() => setSelectedDeposit(row.original as DepositRecord)}
          >
      ...
      <CardContent className="p-6">
        {error ? (
          ...
          <EmptyState
            ...
            description="When you make deposits, they will appear here."
          />
        ) : (
          <DataTable 
            columns={columns} 
